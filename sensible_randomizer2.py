...
habitat_types = {
    ...
    "ForestMid": {"range": (11, 22)},
    "ForestLate": {"range": (28, 42)},
    "ForestEdgeEarly": {"range": (2, 7)},
    "ForestEdgeMid": {"range": (10, 20)},
    "ForestEdgeLate": {"range": (25, 38)},
    "PlainsEarly": {"range": (2, 7)},
    "PlainsMid": {"range": (8, 18)},
    "PlainsLate": {"range": (28, 42)},
    "MeadowEarly": {"range": (8, 15)},
    "MeadowMid": {"range": (14, 25)},
    "MeadowLate": {"range": (29, 39)},
    "MountainFootEarly": {"range": (5, 12)},
    "MountainFootMid": {"range": (15, 26)},
    "MountainFootLate": {"range": (32, 44)},
    "MountainPeakEarly": {"range": (8, 18)},
    "MountainPeakMid": {"range": (20, 35)},
    "MountainPeakLate": {"range": (39, 50)},
    "CaveEntranceEarly": {"range": (5, 12)},
    "CaveEntranceMid": {"range": (18, 26)},
    "CaveEntranceLate": {"range": (35, 48)},
    "CaveDepthEarly": {"range": (7, 19)},
    "CaveDepthMid": {"range": (19, 29)},
    "CaveDepthLate": {"range": (35, 45)},
    "UndergroundLakeSurf": {"range": (25, 40)},
    "UndergroundLakeFish": {"range": (5, 45)},
    "CityOutskirtsEarly": {"range": (2, 7)},
    "CityOutskirtsMid": {"range": (14, 24)},
    "CityOutskirtsLate": {"range": (28, 38)},
    "ShallowSeaSurf": {"range": (10, 30)},
    "ShallowSeaFish": {"range": (15, 35)},
    "DeepSeaSurf": {"range": (20, 40)},
    "DeepSeaFish": {"range": (25, 35)},
    "RiverSurf": {"range": (20, 40)},
    "RiverFish": {"range": (5, 45)},
    "LakeSurf": {"range": (25, 35)},
    "LakeFish": {"range": (5, 45)},
    "VolcanicEarly": {"range": (24, 30)},
    "VolcanicMid": {"range": (30, 36)},
    "VolcanicLate": {"range": (38, 44)},
    "IcyEarly": {"range": (23, 30)},
    "IcyMid": {"range": (30, 40)},
    "IcyLate": {"range": (40, 53)},
    "RuinsEarly": {"range": (10, 18)},
    "RuinsMid": {"range": (18, 30)},
    "RuinsLate": {"range": (39, 50)},
    "MansionEarly": {"range": (18, 28)},
    "MansionMid": {"range": (28, 32)},
    "MansionLate": {"range": (32, 42)},
    "Safari1": {"range": (22, 42)},
    "Safari2": {"range": (22, 42)},
    "Safari3": {"range": (32, 48)},
    "Safari4": {"range": (32, 48)},
    "SafariSurf": {"range": (22, 44)},
    "SafariFish": {"range": (22, 44)},
    "PowerPlant": {"range": (28, 45)},
